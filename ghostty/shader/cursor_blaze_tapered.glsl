...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    trail = mix(TRAIL_COLOR, trail, 1. - pow(smoothstep(0., sdfCurrentCursor + .002, 0.004), 3));
    fragColor = mix(trail, fragColor, 1. - pow(smoothstep(0., sdfCurrentCursor, easedProgress * lineLength), 3));
}
